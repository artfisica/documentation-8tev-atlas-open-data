...
<img src="./Output/jet_eta.jpg" width="150"  />
...
###  1. Analysis/TTbarAnalysis.py
 ...
 ![](Pictures/VimConfigurationpy.png)
 
 Then add a line to fill your new histogram.  
 
 
 ![](Pictures/VimConfigurationFill.png)
...
![](Pictures/VimStandardHistograms.png)
...
![](Pictures/VimPlotConf_TTbarAnalysis.png)
...
```
 ...
 ![](Pictures/OpenAnalysis.png)
 
 Select TTbarAnalysis.py and Open
 
 ![](Pictures/OpenTTbarAnalysis.png)
  

Add a line initialising the histogram jet\_phi, copying what was done for jet\_eta.

![](Pictures/TTbarAnalysisPhi.png)

Then add a line to fill your new histogram

![](Pictures/TTbarAnalysisPhiFill.png)

Save your changes

![](Pictures/TTbarAnalysisSave.png)
...
![](Pictures/AnalysisStandardHistograms.png)
...
![](Pictures/ConfigurationsPlotConf_TTbarAnalysis.png)
